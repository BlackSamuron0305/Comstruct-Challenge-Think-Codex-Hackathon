...
CREATE SCHEMA IF NOT EXISTS catalog AUTHORIZATION comstruct_app;
CREATE SCHEMA IF NOT EXISTS orders  AUTHORIZATION comstruct_app;
CREATE SCHEMA IF NOT EXISTS auth    AUTHORIZATION comstruct_app;
CREATE SCHEMA IF NOT EXISTS audit   AUTHORIZATION comstruct_app;
